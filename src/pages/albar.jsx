      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 h-48 flex items-center justify-center">
          <div className="text-center">
            ...
            />
            <h1 className="text-3xl font-bold text-white mt-4">Muhammad Albar Athaillah</h1>
        ...
        <div className="p-8">
          ...
          <div className="bg-gray-50 p-6 rounded-lg">
            ...
            <p className="text-gray-700 leading-relaxed text-justify">
              ...
              Halo! Perkenalkan nama saya Muhammad Albar Athaillah. Saya adalah seorang mahasiswa 
