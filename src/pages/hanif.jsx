        ...
        <div className="p-8">
          ...
          <div className="bg-gray-50 p-6 rounded-lg">
            ...
            <p className="text-gray-700 leading-relaxed text-justify">
              ...
              pengembangan web dan aplikasi. Selama perkuliahan, saya aktif mengikuti berbagai 
              kegiatan akademik maupun non-akademik yang membantu mengembangkan soft skill dan 
              hard skill saya. Saya senang belajar hal-hal baru dan selalu berusaha untuk berkembang 
              menjadi pribadi yang lebih baik. Di waktu luang, saya menikmati bermain game dan membaca. 
              Saya percaya bahwa dengan belajar dan berlatih secara konsisten, saya dapat mencapai 
              cita-cita saya di masa depan. Saya juga senang berkolaborasi dengan orang lain dan 
              bekerja dalam tim untuk menciptakan sesuatu yang bermanfaat. Terima kasih telah 
              mengunjungi profil saya!
            </p>
          </div>
